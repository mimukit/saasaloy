...
// reverses the six kinds that edit a source or config file (`chained-route`,
// `wrangler-binding`, `plugin-array`, `const-array`, `drizzle-column`, `nav-entry`) and warns about the
