            ...
            <div className="relative z-10 mx-auto w-full max-w-5xl sm:pl-6">
              <div className="flex items-center justify-between max-md:flex-col">
                ...
                >
                  ...
                  <div className="bg-card ring-border shadow-foreground/6.5 absolute inset-0 m-auto mt-auto flex h-fit min-w-sm justify-between gap-3 rounded-full p-2 shadow-xl ring-1 sm:inset-2 dark:shadow-black/6.5">
