...
// the column and the insert fails the NOT NULL constraint. Both are gone below, and
// (`providerId`, `accountId`) is the row's identity again. A project that applied the
