...
A capability takes **drivers** when the project queries and migrates the state the capability holds, and **providers** when the platform owns that state or the service holds none. This is the system-of-record test, and it replaces the stateless/stateful wording that [ADR 0001](adr-0001-all-in-on-cloudflare-2026-07-22.md)'s 2026-08-04 amendment and [ADR 0026](adr-0026-database-driver-split-2026-08-28.md) both lean on. Under the new test `queue`, `kv`, `email`, `sms` and `logger` take providers; `database` and `storage` take drivers. Settled while planning issue [#125](https://github.com/mimukit/saasaloy/issues/125) (`docs/plans/plan-queue-capability-module-2026-09-08.md`).
...
## References
Issue [#125](https://github.com/mimukit/saasaloy/issues/125), `docs/plans/plan-queue-capability-module-2026-09-08.md`. Amends [ADR 0001](adr-0001-all-in-on-cloudflare-2026-07-22.md) (its 2026-08-04 amendment) and [ADR 0026](adr-0026-database-driver-split-2026-08-28.md). Related: [ADR 0020](adr-0020-capability-owns-its-vendor-packages-2026-07-24.md), [ADR 0021](adr-0021-pulumi-iac-engine-for-infra-2026-07-25.md), [ADR 0028](adr-0028-routes-register-by-chained-route-patch-2026-08-28.md). Glossary: `CONTEXT.md` → "Provider module", "Driver module", "Job", "Schedule", "Handler set".
