...
## Status
accepted — refines [ADR 0007](0007-adr-agent-native-static-agents-md-copied-skills-2026-07-22.md) (module guidance as copied Claude skill folders) by pinning the skill **name**space.
...
## References
Plan: `docs/plans/0005-plan-api-capability-module-2026-07-23.md`. Convention doc: `.agents/skills/create-module/SKILL.md` (Step 4 + checklist). Glossary: `CONTEXT.md` (Module skill). Schema: `packages/cli/schemas/registry-item.schema.json`. Related: [ADR 0007](0007-adr-agent-native-static-agents-md-copied-skills-2026-07-22.md), [ADR 0013](0013-adr-module-dependency-ownership-and-scaffolds-files-split-2026-07-23.md). Issue: #8.
