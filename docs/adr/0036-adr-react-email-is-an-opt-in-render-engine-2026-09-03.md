...
Plans: `docs/plans/0043-plan-email-react-templates-2026-09-03.md` (this decision), `docs/plans/0020-plan-email-capability-module-2026-08-04.md` §Templating (reversed here). Prior: [ADR 0014](0014-adr-saasaloy-prefixed-module-skill-names-2026-07-23.md), [ADR 0020](0020-adr-capability-owns-its-vendor-packages-2026-07-24.md). Code: `modules/email-react/`, `scripts/verify-pins.ts`, `packages/cli/templates/base/packages/tsconfig/base.json`. Issues: [#59](https://github.com/mimukit/saasaloy/issues/59), [#15](https://github.com/mimukit/saasaloy/issues/15).
