...
## Status
accepted — extends [ADR 0010](0010-adr-config-patch-magicast-jsonc-parser-2026-07-22.md) (the patch engine) by pinning how patches are expressed in a descriptor and applied by the applier.
...
## References
Plan: `docs/plans/0008-plan-database-capability-module-2026-07-24.md`. Prior: [ADR 0010](0010-adr-config-patch-magicast-jsonc-parser-2026-07-22.md), [ADR 0013](0013-adr-module-dependency-ownership-and-scaffolds-files-split-2026-07-23.md). Engine: `packages/cli/src/lib/patch/`. Schema: `packages/cli/schemas/registry-item.schema.json`. Issues: #9, #7, #6, #27.
</content>
