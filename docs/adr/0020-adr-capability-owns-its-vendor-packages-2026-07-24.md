...
Deliberately **not** part of the rationale: "swapping providers rewrites one function body." It doesn't. A swap changes `envVars` and `patches` too, which is exactly why a provider is a whole module (see [ADR 0001](0001-adr-all-in-on-cloudflare-2026-07-22.md)'s 2026-08-04 amendment) rather than a branch inside one.

## References
Issues #12, [#15](https://github.com/mimukit/saasaloy/issues/15). Prior: [ADR 0005](0005-adr-two-tier-convention-based-modules-2026-07-22.md), [ADR 0013](0013-adr-module-dependency-ownership-and-scaffolds-files-split-2026-07-23.md), [ADR 0018](0018-adr-database-depends-on-api-2026-07-24.md). Glossary: `CONTEXT.md` → "Capability module", "Provider module".
