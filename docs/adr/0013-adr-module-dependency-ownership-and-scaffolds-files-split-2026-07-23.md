...
## Status
accepted — extends [ADR 0005](0005-adr-two-tier-convention-based-modules-2026-07-22.md) (two-tier convention-based modules) by pinning how the two tiers express dependencies and file placement.
...
## References
Plan: `docs/plans/0005-plan-api-capability-module-2026-07-23.md`. Convention doc: `.agents/skills/create-module/SKILL.md` (field notes + `scaffolds` guidance, updated alongside this ADR). Schema: `packages/cli/schemas/registry-item.schema.json`. Issue: #8.
