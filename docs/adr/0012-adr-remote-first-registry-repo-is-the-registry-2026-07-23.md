...
## Status
accepted — amends [ADR 0002](0002-adr-local-applier-over-shadcn-descriptors-2026-07-22.md) (collapses its deferred `readFile → fetch` graduation into now, and revises its "pin to tags, never `main`" consequence — see Consequences).
...
## References
Plan: `docs/plans/0004-plan-remote-module-registry-2026-07-23.md`. Issues: #23 (this), #26 (cross-repo deps), #27 (`remove`), #17 (update flow, amended).
