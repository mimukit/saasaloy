...
_Generated 2026-08-01 · covers commit `7a63705` (branch `issue-41-upgrade-the-base-to-astro-7-and-exact-pins`, vs `origin/main`) — issue #41, Phase 0 of `docs/plans/0013-plan-ui-blocks-2026-08-01.md`_
...
- **Downstream modules on Astro 7** — `add api` / `add database` / `add waitlist` against an Astro 7 base is out of scope for this Phase 0 change and is covered by the later phases of `docs/plans/0013-plan-ui-blocks-2026-08-01.md`. Note `deps:check` already shows those modules pinning Vite 8.1.5.
