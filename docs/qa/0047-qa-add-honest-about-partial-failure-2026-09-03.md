...
1. Read the ADR end to end.
   ...
   ```sh
   cat docs/adr/0031-adr-re-run-is-recovery-for-a-partial-add-2026-09-03.md
   ```
...
2. Read the Consequences section against the code path.
   ...
   ```sh
   sed -n '/Consequences/,$p' docs/adr/0031-adr-re-run-is-recovery-for-a-partial-add-2026-09-03.md
   ```
