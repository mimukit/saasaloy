...
[`0024-qa-init-git-init-2026-08-09.md`](0024-qa-init-git-init-2026-08-09.md) covers all eight of its shapes
...
2. Read the three places a person would land after seeing that error:
   ...
   - `docs/adr/0025-adr-the-linter-runs-on-the-compiler-we-ship-2026-08-09.md` — the
...
[`0024-qa-init-git-init-2026-08-09.md`](0024-qa-init-git-init-2026-08-09.md) is the plan for this behaviour and
