...
### TC-5 — ADR 0013 + ADR 0014 read coherently to a reviewer  ·  🟡 Normal
**Steps**
1. Read `docs/adr/0013-adr-module-dependency-ownership-and-scaffolds-files-split-2026-07-23.md`.
2. Read `docs/adr/0014-adr-saasaloy-prefixed-module-skill-names-2026-07-23.md`.
