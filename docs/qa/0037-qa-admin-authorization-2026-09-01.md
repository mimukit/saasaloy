...
This plan does not repeat the runtime refusal or the first-admin path. Both are already written, with commands, in `docs/qa/0033-qa-admin-app-module-2026-08-29.md` (the 08-29 plan), which this branch extended:
...
```sh
grep -n "admin/users\|403\|first sign-up\|simultaneous" docs/qa/0033-qa-admin-app-module-2026-08-29.md
```
