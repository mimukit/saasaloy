...
- ✅ `docs/adr/0036-adr-react-email-is-an-opt-in-render-engine-2026-09-03.md` exists, holds `## Status`, records request-time render, the opt-in module shape and the measured byte counts
