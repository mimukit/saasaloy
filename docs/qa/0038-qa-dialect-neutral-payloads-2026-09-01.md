...
1. Read `docs/adr/0029-adr-auth-holds-a-request-scoped-db-client-2026-08-31.md`.
...
2. Read the amendment in `docs/adr/0026-adr-database-driver-split-2026-08-28.md`.
...
- ✅ P5-2 a new ADR records the request-scoped db client → `0029-adr-auth-holds-a-request-scoped-db-client-2026-08-31.md`, with Status, Considered Options, Consequences and References.
