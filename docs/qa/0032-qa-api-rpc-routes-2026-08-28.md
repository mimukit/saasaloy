...
- ✅ C13 → `0028-adr-routes-register-by-chained-route-patch-2026-08-28.md` exists, next to ADR 0022. Its headings match ADR 0022's, it is marked `accepted — amends ADR 0005`, and it names four rejected alternatives.
