...
1. Read `docs/adr/0026-adr-database-driver-split-2026-08-28.md`.
...
- ✅ C2.5, presence only → `0026-adr-database-driver-split-2026-08-28.md` carries `accepted, amended 2026-08-31`, a marked retraction and an amendment section. The wording is TC-4.2.
