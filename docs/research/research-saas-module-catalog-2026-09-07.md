...
The [Phase 3 plan](../plans/plan-phase-3-modules-2026-07-22.md) remains useful as an earlier proposal. Its empty-registry assumption and several extension conventions no longer match the code. Its exclusion of Postgres also predates the existing driver.
