...
Issue: [#167](https://github.com/mimukit/saasaloy/issues/167). Filed from [#165](https://github.com/mimukit/saasaloy/issues/165), whose Phase 2 this is. The old Phase 2 of that issue is absorbed here and needs no separate work.
...
### Phase 1: move the rule and the lock into `teams` (#167)
...
### Phase 2: move the request path, the example and the screen into `multitenant` (#167)
...
### Phase 3: retire `modules/rbac/` (#167)
...
### Phase 4: rename the files, the subpaths and `requireCan` (#167)
...
### Phase 5: vocabulary, removal behaviour and migration (#167)
