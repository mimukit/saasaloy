...
Issue: [#127](https://github.com/mimukit/saasaloy/issues/127). Source: `docs/plans/plan-module-catalog-2026-09-07.md` (P0 #5), `docs/research/research-module-libraries-2026-09-07.md`. Blocked by [#125](https://github.com/mimukit/saasaloy/issues/125) (`queue`) for the export, import, sweep and purge jobs only.
