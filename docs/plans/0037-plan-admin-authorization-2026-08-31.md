...
| #13's AC and the 08-27 QA plan need updating | That QA file does not exist; `0033-qa-admin-app-module-2026-08-29.md` already tests the non-admin denial |
