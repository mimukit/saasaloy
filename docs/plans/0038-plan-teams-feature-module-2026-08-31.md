...
`saasaloy add teams` must give a generated project multi-tenant organizations backed by Better Auth's organization plugin. The build spec (`docs/plans/0001-plan-saasaloy-build-spec-2026-07-21.md`, line 33 and line 61) names that plugin as a **feature module**, not part of the base, and names the plugin-array patch as the mechanism that installs it.
