...
> **Status: research report and priority list, not a build plan.** It widens the Phase-3 roadmap (`0002-plan-phase-3-modules-2026-07-22.md`) into a full catalog, and it ranks the catalog. Each module still goes through `create-module` / `create-provider` at build time. Dates on sources are the dates the pages were read or published; all reads happened on 2026-09-07.
