...
`packages/ui/src/styles/globals.css`, seven vendored blocks ([ADR 0022](../adr/0022-adr-design-layer-ships-in-the-base-2026-08-06.md)) — and no
...
| Decision | Resolution |
|----------|-----------|
| **Base, not a module** | Same argument [ADR 0022](../adr/0022-adr-design-layer-ships-in-the-base-2026-08-06.md) made for the design layer itself and [#71](https://github.com/mimukit/saasaloy/issues/71) reused for the linter: every project wants it, so an opt-in module is a step everyone takes. Inverting it is worse — a module shipping UI would `dependsOn` a documentation artifact with no capability. |
