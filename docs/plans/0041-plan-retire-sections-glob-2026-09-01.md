...
Success: the glob is gone, module UI lands in `packages/ui/src/blocks/` exactly like base blocks, the applier prints precise wire-up instructions, and `remove` still works. The waitlist proof (docs/qa/0010-qa-waitlist-module-2026-07-24.md) still passes end to end.
...
- Run the waitlist proof in `.dev` per `docs/qa/0010-qa-waitlist-module-2026-07-24.md`: scaffold, add waitlist, follow the printed wire-up, confirm the form submits end to end. Update the QA doc's steps for the new wire-up.
