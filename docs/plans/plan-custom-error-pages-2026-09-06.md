...
### Phase 1: the shared error block
...
### Phase 2: `apps/web` 404, 500, and the Cloudflare adapter
...
### Phase 3: admin not-found and error screens
...
### Phase 5: docs and module descriptors
